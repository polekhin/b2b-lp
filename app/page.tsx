  ...
  return (
    <main>
      ...
      <section className="cta-band">
        <div><span>07 — ПОЧЕМУ СЕЙЧАС</span><h2>Поймите свою точку старта <em>в освоении работы с ИИ</em></h2></div>
      ...
      <section className="section project" id="project">
        ...
        <div className="project-grid"><h2>Развиваем готовность к использованию <em>ИИ в России</em></h2><div><p className="big-copy">ИИ Чекап помогает людям и организациям оценить готовность к работе с искусственным интеллектом и определить направления развития.</p></div></div>
