...
const experts = [
  ["Анна Морозова", "Эксперт по ИИ-грамотности", "АМ", "Чекап — понятная стартовая точка. Он показывает, какие навыки уже есть и куда двигаться дальше. Особенно важно, что результат не сравнивает человека с другими, а помогает увидеть собственный прогресс и выбрать реалистичный следующий шаг."],
  ["Михаил Соколов", "Директор по цифровой трансформации", "МС", "Я пройду тест сам и предложу его команде. Такой срез помогает говорить о развитии предметно: не на уровне общих впечатлений, а через конкретные компетенции, рабочие сценарии и зоны, где обучение даст самый заметный эффект."],
  ["Елена Воронцова", "Руководитель образовательных программ", "ЕВ", "Методика помогает оценить не знание сервисов, а понимание возможностей, рисков и ответственности. Это делает результат полезным и для новичков, и для тех, кто уже применяет ИИ и хочет использовать его более осознанно."],
  ["Алексей Громов", "Эксперт по внедрению ИИ", "АГ", "Организациям важно сначала увидеть точку старта. Тогда внедрение становится последовательным и управляемым: проще определить приоритетные процессы, подготовить команду и избежать разрозненных инициатив без понятной бизнес-ценности."],
  ["Дарья Белова", "Специалист по оценке компетенций", "ДБ", "Здесь нет плохого результата. Есть честная картина, которая помогает выбрать следующий шаг. Чекап снимает тревогу перед новой технологией и превращает абстрактное желание развиваться в понятный персональный маршрут."],
];
  ...
  return (
    <main>
      <header className="nav">
        ...
        <nav aria-label="Основная навигация"><a href="#about">О чекапе</a><a href="#audience">Для кого</a><a href="#process-flow">Как проходит</a><a href="#outcomes">Что вы получите</a><a href="#method">Методика</a><a href="#project">О проекте</a></nav>
      ...
      <section className="section intro" id="about">
        ...
        <h2 className="intro-title">ИИ Чекап — не экзамен,<br />а <em>первый шаг к уверенной работе с ИИ</em></h2>
      ...
      <section className="section methodology" id="method">
        ...
        <div className="method-grid">
          ...
          <article><span>02</span><h3>Тест валидирован ведущими экспертами российского рынка</h3><p>Методику и вопросы ИИ Чекапа создали эксперты в области искусственного интеллекта, образования и оценки компетенций с учетом российского контекста и реальных сценариев использования ИИ.</p></article>
        </div>
        <div className="expert-slider">{experts.map(([n,r,initials,q])=><article key={n}><p>«{q}»</p><div className="expert-person"><span className="expert-photo" aria-hidden="true">{initials}</span><span className="expert-meta"><strong>{n}</strong><span>{r}</span></span></div></article>)}</div>
        <h3 className="process-title" id="process-flow">Один простой процесс. <em>Два понятных результата</em></h3>
        ...
        <div className="result-paths">
          <article className="path-personal"><span>Для каждого</span><h3>Вы увидите, насколько уверенно используете ИИ сегодня, какие навыки уже развиты и что стоит улучшить.</h3><p>Результат поможет:</p><ul><li>понять, куда развиваться дальше</li><li>эффективнее решать рабочие и повседневные задачи</li><li>экономить время на рутинных процессах</li><li>повышать свою конкурентоспособность на рынке труда</li></ul><button onClick={()=>scrollToForm("personal")}>Пройти персональный ИИ Чекап <Arrow /></button></article>
          <article className="path-corporate"><span>Для компаний</span><h3>Вы получите общую картину готовности компании к использованию ИИ, увидите сильные стороны и основные зоны развития.</h3><p>Результат поможет:</p><ul><li>определить, какие ИИ-компетенции важно развивать у сотрудников</li><li>найти процессы, где ИИ может быстрее всего повысить эффективность</li><li>выбрать приоритетные направления внедрения ИИ</li><li>снизить риск разрозненных и неэффективных инициатив</li><li>подготовить команду к изменениям и усилить конкурентоспособность бизнеса</li></ul><button onClick={()=>scrollToForm("corporate")}>Пройти корпоративный ИИ Чекап <Arrow /></button></article>
        </div>
      </section>
      ...
      <section className="section outcomes" id="outcomes">
        ...
        <div className="outcome-grid">
          <article><span>Персональный ИИ Чекап</span><strong>Персональный ИИ чекап</strong><ul><li><Check /> Персональный ИИ Индекс</li><li><Check /> оценку по каждому направлению</li><li><Check /> профиль сильных сторон и зон развития</li><li><Check /> базовые рекомендации</li><li><Check /> сертификат участника</li></ul></article>
          <article><span>Корпоративный ИИ Чекап</span><strong>Корпоративный ИИ чекап</strong><ul><li><Check /> Корпоративный ИИ Индекс</li><li><Check /> оценку по каждому направлению</li><li><Check /> базовые рекомендации для организации</li><li><Check /> возможность получить подробный аналитический отчет с планом развития</li></ul></article>
        </div>
        <div className="section-cta"><button className="button" onClick={() => scrollToForm()}>Получить свой ИИ Индекс <Arrow /></button></div>
      </section>

      <section className="cta-band">
        <div><span>07 — ПОЧЕМУ СЕЙЧАС</span><h2>Определите свою точку старта в работе с ИИ и <em>поймите, куда развиваться дальше</em></h2></div>
        <div className="cta-reasons"><p><b>01</b>ИИ уже меняет учебу, работу и повседневную жизнь. Пройдите диагностику, чтобы определить направления дальнейшего развития.</p><p><b>02</b>Диагностика доступна после регистрации, а результаты можно получить сразу после прохождения.</p><p><b>03</b>Специальная подготовка не требуется. Даже если вы пока неуверенно пользуетесь ИИ, чекап спокойно покажет вашу точку старта и подскажет, с чего начать.</p><button className="button dark" onClick={() => scrollToForm()}>Зарегистрироваться <Arrow /></button></div>
      </section>

      <section className="section project" id="project">
        <div className="section-number">08 — О ПРОЕКТЕ</div>
        <div className="project-grid"><h2>Развиваем готовность к использованию <em>ИИ в России</em></h2><div className="project-statement-wrap"><p className="project-statement">ИИ Чекап помогает людям и организациям оценить готовность к работе с искусственным интеллектом и определить направления развития.</p></div></div>
        <h3 className="priority-title">Мы в контексте государственных приоритетов</h3>
        ...
        <div className="project-bottom">
          <div className="project-directions"><strong>Проект соответствует ключевым направлениям развития ИИ в России:</strong><ul><li>развитие компетенций</li><li>повышение готовности к внедрению ИИ</li><li>рост эффективности людей и организаций</li><li>ответственное использование технологий</li></ul></div>
